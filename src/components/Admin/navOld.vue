  ...
  export default {
    ...
    data() {
      return {
        ...
        { id: 6, label: 'พาร์ทเนอร์ใหม่', route: '/ParthnerView'  },
        // {
        //     id: 2, label: 'งาน',  subItems: [
        //       { id: 2, label: 'เพิ่มงาน', route: '/AddWork'  },
        //       { id: 2, label: 'งานทั้งหมด', route: '/WorkView'  }
        ...
        //   },
          ...
          {
            id: 2, label: 'พนักงาน',  subItems: [
              { id: 2, label: 'พนักงานทั้งหมด', route: '/employee/all'  }
            ]
          },
