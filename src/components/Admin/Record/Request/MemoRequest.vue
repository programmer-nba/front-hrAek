                ...
                <table class="w-full border">
                    <thead>
                        <tr
                            ...
                            <th class="px-2 py-3 ">เลขที่ข้อความ</th>
                            ...
                            <th class="px-2 py-3">วันที่ทำรายการ</th>
                    ...
                    <template v-if="paginatedItems.length > 0">
                        <tbody class="bg-white">
                            <tr v-for="( record, index) in paginatedItems" :key="index" class="text-[#000000] ">
                                ...
                                <td class="px-2 py-3 border border-[#0C359E]">
                                ...
                                <td class="px-2 py-3 text-sm border border-[#0C359E]"
                                    style="vertical-align: top; max-width: 600px;">
                                    <p class=" text-black"> หัวข้อ: {{ record.Headers }}</p>
                                    <p class=" text-black"> เรียน: {{ record.To }}</p>

                                    <div style="overflow-wrap: break-word;  max-height: 100px; overflow-y: auto; ">
                                        <p class="text-gray-700" v-html="record.Detail"></p>
                                    </div>
                                </td>

                                <td class="px-2 py-3 text-sm border whitespace-nowrap text-center border-[#0C359E]">


                                    <span
                                        class="py-2 px-2 flex items-center justify-center to-transparent border-2 text-white text-sm rounded-full "
                                        :class="{
                                ...
                                <td class="px-2 py-3 text-sm border  border-[#0C359E] whitespace-nowrap">
                                    <div class="flex-wrap flex gap-2 flex-col">
                                        ...
                                        <button @click="confirmRejectDocument(record)"
                                            ...
                                            <span class="text-md text-red-900 text-base font-normal">ไม่อนุมัติ</span>
                                        </button>
