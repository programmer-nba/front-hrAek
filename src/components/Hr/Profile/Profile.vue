      ...
      <div class="md:flex no-wrap md:-mx-2">
        ...
        <div class="w-full md:w-3/12 md:mx-2">
          ...
          <div class="bg-white p-3 border-t-4 border-green-400">
            ...
            <div v-if="imageUrl" class="flex justify-center mt-2">
              <button
                @click="SaveImage"
                class="btn_center text-sm text-white px-6 py-2"
              >
                ยืนยัน
              </button>
            </div>
            ...
            <div class="grid gap-4 mt-2">
              <div class="flex gap-2 items-center">
                ...
                <div class="grid text-sm">
                  ...
                  <div class="text-xs text-gray-500">คงเหลือ 30 วัน / ปี</div>
                </div>
              </div>
              <div class="flex gap-2 items-center">
                <div
              ...
              <div class="flex gap-2 items-center">
                ...
                <div class="grid text-sm">
                  <h2 class="font-semibold leading-none">10 วัน</h2>
                  <div class="text-xs text-gray-500">คงเหลือ 98 วัน / ปี</div>
                </div>
              </div>
            </div>
          </div>
        ...
        <div class="w-full md:w-9/12 mx-2 h-64">
          ...
          <div class="bg-white p-3 shadow-sm rounded-sm">
            ...
            >
              <span
                class="flex items-center gap-2 tracking-wide bg-blue-500 rounded-lg p-2 text-white"
              >
                <svg
                  class="h-5"
                  xmlns="http://www.w3.org/2000/svg"
            ...
            <div class="text-black">
              <div class="grid md:grid-cols-2 text-sm">
                ...
                <div class="grid grid-cols-2">
                  ...
                  <div
                    class="px-2 py-2 bg-gray-200 border-gray-500 border-2 rounded-lg"
                  >
                    {{ me.address }} ตำบล {{ me.subdistrict }} อำเภอ
                    {{ me.district }} จังหวัด {{ me.provice }} {{ me.postcode }}
                  </div>
                </div>
              </div>
            </div>
            <div class="flex justify-center w-full">
              <button
                @click="showDialog"
                class="block w-full bg-blue-500 border-blue-500 border-2 text-white text-sm font-semibold rounded-lg hover:bg-blue-200 hover:text-blue-500 focus:outline-none focus:shadow-outline focus:bg-gray-100 hover:shadow-xs p-3 my-4"
              >
                แก้ไขข้อมูลส่วนตัว
              </button>
            </div>
