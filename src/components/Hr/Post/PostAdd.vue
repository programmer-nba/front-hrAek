            ...
            <div>
              ...
              <div class="flex">
                <input
                  ...
                  name="amount"
                  id="amount"
                  class="bg-gray-50 border-r border-gray-300 text-gray-900 text-sm rounded-l-lg focus:ring-primary-600 focus:border-primary-600 block w-full py-2 leading-tight"
          ...
          <div class="grid grid-cols-1 md:grid-cols-2 gap-6 mt-4">
            <div class="grid grid-cols-3 gap-2">
              <div class="col-span-2">
                ...
                <div class="flex">
                  <input
                    v-model.number="formData.start_age"
                    type="number"
                    name="start_age"
                    id="start_age"
                  ...
                  <input
                    v-model.number="formData.end_age"
                    type="number"
                    name="end_age"
                    id="end_age"
  ...
  methods: {
    ...
    async fetchPostTypes() {
      try {
        ...
        console.log('response ExamType',response);
    ...
    async addPost() {
      try {
        ...
        console.log("formDataformDataformData", Object.fromEntries(formData));
        await Swal.fire({
          ...
          if (result.isConfirmed) {
            const response = await axios.post(
              `${import.meta.env.VITE_VUE_APP_DECCAN}/post/insert-post`,
              formData,
              {
                headers: {
