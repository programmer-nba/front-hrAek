        ...
        <button class="rounded-lg bg-indigo-50/30 p-3 hover:bg-white hover:text-indigo-500">
          <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24">
            <g fill="none" stroke="currentColor" stroke-linecap="round" stroke-width="2">
              ...
              <path stroke-dasharray="6" stroke-dashoffset="6" d="M21 12l-3.5 -3.5M21 12l-3.5 3.5" opacity="0">
      ...
      <main class="grid grid-cols-1 lg:grid-cols-2 gap-6 py-4 w-2xl container px-2 mx-auto">
        <aside class="">
          <div class="flex items-center justify-center text-[#9e9cb6]">
            <section class="w-full relative bg-[#79E0EE]/60 rounded-[6px] mx-2">
              ...
              <img :src="getImageUrl(ME.image)"
                class="rounded-full w-[120px] h-[120px] mx-auto my-10 p-0 border-[6px] object-cover border-[#231f39] shadow-[0px_27px_16px_-11px_rgba(31,27,56,0.25)] transition-all duration-150 ease-in hover:scale-105 cursor-pointer slide-in-elliptic-top-fwd"
                v-if="ME.image" alt="Profile Image" />
              <span v-else
                class="flex items-center justify-center w-[120px] h-[120px] text-xl text-gray-400 bg-gray-200 rounded-full my-10 mx-auto">ไม่มีรูปภาพ</span>
              <h1 class="text-xl font-bold text-center text-[#11009E]">
                {{ ME.first_name }} {{ ME.last_name }}
              </h1>
              <p class="font-semibold text-center text-[#11009E]">
                {{ ME.position }}
              </p>
              ...
              <div class="flex items-center justify-center gap-2 w-[80%] mx-auto mt-5 mb-10">
                <button @click="logWorkTime"
                  class="flex-1 border border-[#231f39] rounded-[4px] py-3 text-white bg-[#231f39] transition-all duration-150 ease-in hover:bg-[#472e99]">
                  ลงเวลาเข้างาน
                </button>
              </div>
                ...
                <div class="flex-1 w-0">
                  <div class="flex flex-col justify-center items-center">
                    ...
                    <h1 class="text-lg text-white">
                      {{ TimeToDay.morningIn ? TimeToDay.morningIn : "-" }}
                    </h1>
                  </div>
                  <div class="flex flex-col justify-center items-center">
                    <h4 class="text-xs font-semibold text-white">
          ...
          <div class="bg-white shadow mt-6 rounded-lg p-6">
            <h3 class="text-black text-sm font-semibold mb-4">
              ประวัติการเข้างาน
            </h3>
            ...
            <div class="flex flex-col justify-center items-center">
              <div
                ...
                <div
                  class="flex h-fit w-full items-center justify-between rounded-t-2xl bg-white px-4 pb-[20px] pt-4 shadow-2xl shadow-gray-100">
                    ...
                    <thead class="bg-[#141E46]">
                      <tr class="text-center text-sm text-white">
                        <th style="cursor: pointer" class="px-2 py-2 whitespace-nowrap">
                          <div class="ml-2 flex items-center justify-between py-2 px-2 text-start">
                            วันที่
                          </div>
                        </th>
                        ...
                        <tr v-for="(item, index) in TimeToWork" :key="index" role="row">
                          <td class="py-3 text-sm" role="cell">
                            <div class="flex items-center gap-2">
                              <p class="text-sm ml-2 font-medium" :class="{
          'text-[#FF004D]': index === 0,
          'text-[#313866]': index !== 0,
          ...
          <div class="bg-white shadow rounded-lg p-4">
            <div class="flex flex-col gap-2">
              ...
              <div class="w-full relative bg-white shadow p-2 rounded">
                ...
                <div class="flex flex-wrap p-2 w-full gap-4">
                  <div class="flex justify-between w-full">
                    <div class="flex flex-col w-full">
                      ...
                      <h1 class="text-lg text-[#212A3E]">
                        6-Frais de scolarité 2eme trimestre
                      </h1>
                    </div>
                ...
                <a-progress :percent="50" status="active" :strokeColor="'orange'" :trailColor="'lightgrey'" />
              </div>
            </div>
          </div>

          <div class="bg-white shadow rounded-lg"></div>
