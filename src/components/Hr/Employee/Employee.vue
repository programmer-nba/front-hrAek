<template>
  <div>
    ...
    >
      <div class="mb-6">
        ...
        <div class="container flex justify-center mx-auto pt-2">
          <div>
            <h1
              class="xl:text-4xl text-3xl text-center text-gray-800 font-extrabold sm:w-6/6 w-6/6 mx-auto"
            >
              รายละเอียดพนักงาน
            </h1>
          </div>
      ...
      <div class="bg-gradient-to-r from-pink-300 to-indigo-300">
        <div class="grid grid-cols-12 gap-0">
          <div
            class="col-span-12 sm:col-span-12 md:col-span-12 lg:col-span-12 xxl:col-span-12 px-6 py-6"
          >
            <div class="grid grid-cols-12 gap-6">
              <div
                class="col-span-12 sm:col-span-12 md:col-span-6 lg:col-span-12 xxl:col-span-6"
              >
                <!-- Start Nav Bar -->
              ...
              <div
                class="col-span-12 sm:col-span-12 md:col-span-6 lg:col-span-6 xxl:col-span-6"
              >
                <!-- Start Card List -->
                <div
          ...
          <div
            class="col-span-12 sm:col-span-12 md:col-span-12 lg:col-span-12 px-6 py-6"
          >
            <div class="grid grid-cols-12 gap-6">
              <div
                class="col-span-12 sm:col-span-12 md:col-span-6 lg:col-span-6 xxl:col-span-6"
              >
                <div class="bg-white rounded-xl p-4 shadow-xl">
                  <div class="flex flex-col justify-center items-center">
                    <div
                      class="w-32 h-32 rounded-full bg-gray-300 border-2 border-white mt-2"
                    >
                      <img
                    ...
                    <div class="px-6 mt-2">
                      <div class="flex items-center flex-wrap">
                        ...
                        <span class="flex flex-col flex-grow pl-4">
                          <span class="font-bold text-lg text-black -mt-4"
                            >{{ detailEmployee.position }}
                          </span>
                          <span
                            class="text-sm text-black uppercase font-bold"
                            >{{ detailEmployee.role }}</span
                          >
                        </span>
                      </div>
                    </div>
              ...
              <div
                class="col-span-12 sm:col-span-12 md:col-span-6 lg:col-span-6 xxl:col-span-5"
              >
                <div
                  class="p-8 space-y-3 border-2 bg-white border-blue-400 rounded-xl"
                >
            ...
            <div
              class="grid grid-cols-1 gap-8 mt-8 xl:mt-12 xl:gap-12 md:grid-cols-2 xl:grid-cols-2"
            >
              <div
              ...
              >
                <div class="bg-white rounded-2xl py-2">
                  ...
                  <div class="mt-4">
                    <h1
                      class="text-lg text-black font-semibold hover:underline cursor-pointer"
                    >
                      ข้อมูลติดต่อ
                    </h1>
    ...
    <Dialog
      v-model:visible="showAddEmployeeForm"
      :modal="true"
    ...
    <Dialog
      v-model:visible="showEditEmployeePopup"
      :modal="true"
      class="w-full md:w-5/6 lg:w-2/3 xl:w-1/2"
      ...
      <form @submit.prevent="updateEmployee">
        <div class="grid grid-cols-1 md:grid-cols-2 gap-2">
          <div class="flex gap-2">
            <!-- {{ employeeHead }} -->
            <Checkbox
              v-model="editedEmployee.isHeader"
              class="border-2 border-gray-700 rounded-lg"
              binary
            />
            <div>หัวหน้างาน</div>
          </div>
          <div></div>
          <div class="mb-2">
            <label for="name_title" class="block text-sm font-bold mb-2"
              >คำนำหน้า</label
            >
            <select
              v-model="editedEmployee.name_title"
              id="name_title"
          ...
          <div class="mb-2">
            ...
            >
            <input
              v-model="editedEmployee.iden_number"
              type="text"
              id="iden_number"
              class="form-input w-full h-10 border-2 rounded-xl border-gray-700"
            />
          ...
          <div class="mb-2">
            <label for="annual_leave" class="block text-sm font-bold mb-2"
              >ลาหยุดประจำปี</label
            >
            <input
              v-model="editedEmployee.leave.annual_leave"
              type="number"
              id="annual_leave"
              class="form-input w-full h-10 border-2 rounded-xl border-gray-700"
            />
          ...
          <div class="mb-2">
            <label for="business_leave" class="block text-sm font-bold mb-2"
              >ลากิจ</label
            >
            <input
              v-model="editedEmployee.leave.business_leave"
              type="number"
              id="business_leave"
              class="form-input w-full h-10 border-2 rounded-xl border-gray-700"
            />
          ...
          <div class="mb-2">
            <label for="disbursement" class="block text-sm font-bold mb-2"
              >การเบิกจ่าย</label
            >
            <input
              v-model="editedEmployee.leave.disbursement"
              type="number"
              id="disbursement"
              class="form-input w-full h-10 border-2 rounded-xl border-gray-700"
            />
          ...
          <div class="mb-2">
            <label for="maternity_leave" class="block text-sm font-bold mb-2"
              >ลาคลอด</label
            >
            <input
              v-model="editedEmployee.leave.maternity_leave"
              type="number"
              id="maternity_leave"
              class="form-input w-full h-10 border-2 rounded-xl border-gray-700"
            />
          ...
          <div class="mb-2">
            <label for="ordination_leave" class="block text-sm font-bold mb-2"
              >ลาบวช</label
            >
            <input
              v-model="editedEmployee.leave.ordination_leave"
              type="number"
              id="ordination_leave"
              class="form-input w-full h-10 border-2 rounded-xl border-gray-700"
            />
          ...
          <div class="mb-2">
            <label for="sick_leave" class="block text-sm font-bold mb-2"
              >ลาป่วย</label
            >
            <input
              v-model="editedEmployee.leave.sick_leave"
              type="number"
              id="sick_leave"
              class="form-input w-full h-10 border-2 rounded-xl border-gray-700"
            />
    ...
    <div class="bg-gray-50 h-full p-14">
      <div class="bg-">
        <h1 class="text-5xl font-bold mb-4">ข้อมูลพนักงาน</h1>
        <div
          class="grid grid-cols-1 sm:grid-cols-1 md:grid-cols-4 gap-2 items-center justify-center"
        >
          <div class="flex items-center">
            <button
              @click="showAddEmployeeForm = true"
              class="bg-blue-700 hover:bg-blue-500 text-white font-bold py-4 px-4 rounded mb-6"
            >
              เพิ่มข้อมูลพนักงาน
            </button>
          </div>
          ...
          <form class="max-w-sm mx-auto flex items-center">
            <label for="roleFilter" class="text-gray-700 font-semibold mr-2"
              >ตำแหน่ง</label
            >
            <select
          ...
          <div>
            ...
            >
              <button
                @click="showItemsByPosition('grid')"
                :class="{
              ...
              <button
                @click="showItemsByPosition('stack')"
                :class="{
                  'bg-[#1D24CA] text-white hover:bg-[#0F2167]':
                    activeStatus === 'stack',
                }"
        ...
        <div
          class="flex items-start justify-center bg-[#0F2167] min-h-screen rounded-xl"
          v-if="activeStatus === 'grid'"
        >
          <div
              ...
              >
                ...
                >
                  <div class="flex flex-col items-center">
                    ...
                    <span
                      v-else
                      class="w-28 h-28 flex items-center justify-center text-gray-400 bg-gray-200 rounded-full"
                      >ไม่มีรูปภาพ</span
                    >
                    <h4
                      class="text-[#0802A3] text-lg font-bold capitalize text-center"
                    >
                  ...
                  >
                    <span
                      class="text-[#0802A3] flex justify-between items-center"
                    >
                      <svg
                        xmlns="http://www.w3.org/2000/svg"
                        class="mr-1"
                    ...
                    >
                      ...
                      >
                        ...
                        >
                          ...
                          />
                          <path
                            d="M3.507 6.208a1.64 1.64 0 1 0 3.282 0a1.64 1.64 0 0 0-3.282 0"
                          />
                          <path
                  ...
                  <button
                    @click.prevent="viewDetails(employee)"
        ...
        <div class="overflow-x-auto rounded-xl" v-if="activeStatus === 'stack'">
          <table
            class="table-auto w-full border-collapse border border-gray-300 container"
          >
            <thead>
              <tr class="bg-[#0F2167] text-white h-16 text-xl text-center">
                ...
                <th class="px-4 py-2">ชื่อจริง - นามสกุล</th>
            ...
            <tbody>
              ...
              >
                <td
                  class="border flex items-center justify-center border-solid border-gray-700 px-2 py-2"
                >
                  <img
                    :src="
                      employee.image
                  ...
                  <span
                    v-else
                    class="w-20 h-20 flex items-center justify-center text-gray-400 bg-gray-200 rounded-full"
                    >ไม่มีรูปภาพ</span
                  >
                </td>
                ...
                <td class="border border-solid border-gray-700 px-2 py-2">
                  ...
                  <div v-if="employee.permissions[0]" class="text-red-500">
                ...
                <td class="border border-solid border-gray-500 px-4 py-2">
                  <button
                    @click.prevent="confirmDelete(employee._id)"
...
export default {
  ...
  computed: {
    filteredEmployees() {
      if (!this.selectedRole) {
        return this.paginatedEmployees; // If no role selected, return all employees
      }
      // Filter employees by selected role
      return this.paginatedEmployees.filter(
  ...
  watch: {
    // เมื่อค่าของ searchKeyword เปลี่ยนแปลง
    searchKeyword(newKeyword) {
      // เรียกใช้เมธอด searchEmployees เพื่อค้นหาข้อมูลพนักงาน
  ...
  methods: {
    ...
    editEmployee(employee) {
      ...
      const filhead = this.editedEmployee.permissions.includes("head");
      // console.log("filhead", filhead);
      if (filhead) {
        this.editedEmployee.isHeader = true;
      }
    ...
    async updateEmployee() {
      try {
        ...
        if (
          this.editedEmployee.isHeader &&
          this.editedEmployee.isHeader === true
        ) {
          this.editedEmployee.permissions = ["head"];
        } else {
          this.editedEmployee.permissions = [];
        }

        //  ลบ  password  ออกจาก  editedEmployee
        const { password, ...employeeData } = this.editedEmployee;
        // console.log("employeeData", password);
        // return;
        const response = await axios.put(
          `${import.meta.env.VITE_VUE_APP_DECCAN}/update/${
            this.editedEmployee._id
          }`,
          employeeData,
          {
            headers: { "auth-token": `${localStorage.getItem("token")}` },
