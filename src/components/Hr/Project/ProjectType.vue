<template>
  <div>
        ...
        <div class="grid gap-6 mb-3">
          <div>
            <label for="code" class="mb-1 font-medium text-gray-900"
              >รหัสงาน
              <span class="text-purple-500 px-3"
          ...
          <div>
            <label for="name" class="mb-1 font-medium text-gray-900"
              >ชื่อประเภทงาน <span class="text-purple-500 px-3"></span
            ></label>
            <input
          ...
          <div class="w-full overflow-hidden text-sm">
            <label for="roles" class="mb-1 font-medium text-gray-900"
              >สำหรับ<span class="text-purple-500 px-3"
                >(ใครสามารถเข้าถึงงานประเภทนี้ได้บ้าง)</span
              ></label
            >
            <MultiSelect
              panelClass="bg-purple-100"
              scrollHeight="400px"
            ...
            >
              <template #optiongroup="slotProps">
                <div class="flex items-center">
                  <div class="text-purple-500 w-full py-1 px-2 rounded">
    ...
    <div class="flex flex-wrap bg-cyan-200 h-full">
            ...
            <div class="ml-10 py-2 grid grid-cols-1 lg:grid-cols-3 gap-4">
              <div>
                <button
                  ...
                  class="cursor-pointer text-white font-bold shadow-md hover:scale-[0.9] shadow-purple-400 rounded-full px-5 py-2 bg-gradient-to-bl from-purple-500 to-purple-800"
                >
                  เพิ่มประเภทงาน
                </button>
              </div>
