  ...
  <div>
      ...
      <div class="bg-gradient-to-r from-pink-300 to-indigo-300 rounded">
        <div class="grid grid-cols-12 gap-0">
          ...
          <div class="grid grid-cols-2 ">
              ...
              >
                <div
                  class="bg-pink-600  p-3 text-white rounded-xl shadow-xl flex items-center"
                >
          ...
          >
            <div class="grid grid-cols-2 space-y-4">
              ...
              >
                <div
                  class="p-4 space-y-3 border-2 bg-white border-blue-400 rounded-xl "
                >
            ...
            <div
              class="grid grid-cols-1 space-y-4 mt-4"
            >
              <div
    ...
    <Dialog  v-model:visible="showAddEmployeeForm" :modal="true" header="เพิ่มข้อมูลพนักงาน">
      <div class="grid grid-cols-1">
        <div class="grid grid-cols-1 gap-1 mobileL:grid-cols-3">
          <div class="mb-4">
            ...
            <Dropdown v-model="name_title" :options="titleOptions" optionLabel="label" optionValue="value" placeholder="คำนำหน้า" class="text-xs w-full text-gray-700 bg-gray-200 focus:outline-none focus:bg-gray-300 focus:shadow-inner"/>
          </div>
          <div class="mb-4">
            <label for="first_name" class="block text-sm font-bold mb-2">ชื่อจริง</label>
            <input v-model="first_name" type="text" id="first_name" placeholder="กรุณากรอกชื่อจริง" class="form-input w-full h-10 border-2 pl-3 rounded-xl border-gray-700"/>
          </div>
          <div class="mb-4">
      ...
      <div class="flex justify-center mt-6">
        <button @click="saveData" class="bg-blue-500 hover:bg-blue-700 text-white font-bold py-2 px-4 rounded mr-2 w-full mobileL:w-auto">
          เพิ่มข้อมูลพนักงาน
        </button>
      </div>
    </Dialog>
        ...
        <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
          <div class="mb-4">
            <label for="name_title" class="block text-sm font-bold mb-2"
              >คำนำหน้า</label>
            <select v-model="editedEmployee.name_title" id="name_title" class="form-select w-full h-10 border-2 rounded-xl border-gray-700">
    ...
    <div class="bg-cyan-200 h-full">
      <div class="">
        ...
        <div
          class="grid grid-cols-1 gap-2 px-14 "
        >
        ...
        <div
          class="flex items-center justify-center rounded  w-auto min-h-screen mt-4 "
        ...
        >
          ...
          >
            ...
            <div class="flex-1 px-2 sm:px-0">
              <div
                class="mb-10 sm:mb-0 mt-10 grid gap-10 xxl:grid-cols-3 grid-cols-1 xl:grid-cols-2"
              >
                <div
                ...
                >
                  ...
                  <div
                    class="grid mobileL:flex justify-between font-semibold text-sm pt-2"
                  >
                    <p
                      class="text-[#0802A3] flex  items-center"
                    >
                      <svg
                        xmlns="http://www.w3.org/2000/svg"
                        class="mr-1"
            ...
            <tbody>
              <template v-if="mergedEmployees.length === 0">
                <tr>
                  <td
                    colspan="9"
                    class="px-5 py-5 border-1 border-gray-200 bg-white text-center text-lg font-semibold"
                  >
                    ไม่พบข้อมูล
                  </td>
                </tr>
