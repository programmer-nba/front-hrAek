<template>
    ...
    <section class="container px-4 mx-auto mt-4">
        ...
        <div class="mt-6 px-3 w-full flex-wrap">
            <div class="inline-flex flex-wrap overflow-hidden bg-white border divide-x rounded-lg rtl:flex-row">
                ...
                <button @click="showItemsByPosition('รออนุมัติ')"
        ...
        class="w-1/2 md:w-auto px-5 py-2 text-xs font-medium text-black transition-colors duration-200 sm:text-sm hover:bg-gray-100">พนักงาน</button> -->
            ...
            <div class="flex items-center mt-2 ">
                ...
                <input type="text" placeholder="Search" class="block w-full py-2 pr-5 text-black bg-white border border-gray-200 rounded-lg  placeholder-gray-400/70 pl-11 rtl:pr-11 rtl:pl-5 
                ...
                <tbody class="bg-white">
                    <tr v-for="partner in paginatedItems" :key="partner.id" class="text-[#000000]">
                        ...
                        <td class="px-2 py-3 text-sm border border-[#0C359E] text-center">
                            <div>
                                <h4 v-if="partner.partner_company_name" class="text-gray-700"> {{
                                    partner.partner_company_name }}</h4>
                                <h4 v-if="partner.partner_company_number" class="text-gray-700 ">เลขที่: {{
                                    partner.partner_company_number }} </h4>
                                <h4 v-if="partner.partner_company_address" class="text-gray-700 ">ที่ตั้ง: {{
                                    partner.partner_company_address }} </h4>
                        ...
                        <td class="px-4 py-3 text-sm border border-[#0C359E]">
                            ...
                            <div class="flex justify-center gap-3">
                                <PartnerDetail :employee_id="partner._id" :employee="partner" />
...
import PartnerDetail from "./DetailPartner.vue";
...
export default {
    ...
    methods: {
        ...
        async getContractTypes() {
            try {
                const response = await axios.get(`${import.meta.env.VITE_VUE_APP_DECCAN}/base-contract/codes`);
        ...
        clickHandler() {
            ...
            axios.post(`${import.meta.env.VITE_VUE_APP_DECCAN}/partner-contract/create`, data)
                .then(response => {
