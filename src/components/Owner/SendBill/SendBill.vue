<template>
  <div>
    ...
    <Dialog v-model:visible="showSendBill" :modal="true" class="w-1/2"
      header="เพิ่มไฟล์ใบแจ้งหนี้">
          ...
          <div class="shadow-xl">
            ...
            <div class="px-9 pt-5 flex justify-between items-stretch flex-wrap min-h-[70px] pb-0 bg-transparent">
              <h3 class="flex flex-col items-start justify-center m-2 ml-0 font-medium text-xl/tight text-dark">
                <span class="mr-3 font-semibold text-dark text-3xl">ใบแจ้งหนี้เดือน {{ new Date().getMonth() + 1 }} /
            ...
            <div class="px-10 space-y-4">
              <div class="flex md:justify-start justify-center">
                <button @click="toggleAddSendBill"
...
export default {
  ...
  methods: {
    ...
    toggleAddSendBill() {
      this.showSendBill = !this.showSendBill;
    },
    async submitProject() {
