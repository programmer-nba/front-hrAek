<template>
    <div class="bg-cyan-200 h-[200vh] md:h-[150vh] lg:h-[100vh]">
            ...
            <div class="md:flex no-wrap md:mx-2 ">
                ...
                <div class="w-full md:w-3/12 md:mx-2">
                    ...
                    <div class="bg-white p-3  rounded">
                        ...
                        <ul
                            ...
                            <li class="flex items-center py-1 text-black">
                        ...
                        <button @click="editpassword = true"
                            class="p-2 w-full text-white text-base rounded    bg-blue-500   hover:bg-blue-700">
                            เปลี่ยนรหัสผ่าน
                        </button>
                ...
                <div class="w-full md:w-9/12 mx-2 h-64">
                    ...
                    <div class="bg-white p-3 shadow-sm rounded">
                        <div
                            class="flex items-center space-x-2 font-semibold text-gray-900 leading-8 justify-center mb-2 sm:justify-start">
                            <p>ข้อมูลส่วนตัว</p>
                        </div>
                        <div class="text-black">
                            <div class="space-y-2">
                                <div class="grid grid-cols-1 md:grid-cols-4">
                                    <div class=" font-semibold p-1">ชื่อ-นามสกุล</div>
                                    <div class="flex items-center p-2 rounded-lg border bg-gray-50 col-span-3">{{
                                        me.name_title }} {{ me.first_name }} {{ me.last_name }}
                                    </div>
                                </div>
                                <div class="grid grid-cols-1 md:grid-cols-4">
                                    <div class="p-2 font-semibold">ชื่อเล่น</div>
                                    <div
                                        :class="[me.nick_name ? 'p-2' : 'p-3', 'rounded-lg', 'border', 'bg-gray-50', 'col-span-3']">
                                        <a class="text-blue-800">{{ me.nick_name }}</a>
                                    </div>

                                </div>
                                <div class="grid grid-cols-1 md:grid-cols-4">
                                    <div class="p-2 font-semibold">เพศ</div>
                                    <div class="p-2   rounded-lg border bg-gray-50 col-span-3"
                                        v-if="me.name_title === 'นาย'">ชาย</div>
                                    <div class="p-2   rounded-lg border bg-gray-50 col-span-3" v-else>หญิง
                                    </div>
                                </div>
                                <div class="grid grid-cols-1 md:grid-cols-4">
                                    <div class="p-2 font-semibold ">เลขบัตรประชาชน</div>
                                    <div
                                        :class="[me.iden_number ? 'p-2' : 'p-3', 'rounded-lg', 'border', 'bg-gray-50', 'col-span-3']">
                                        <a class="text-blue-800">{{ me.iden_number }}</a>
                                    </div>
                                </div>
                                <!-- <div class="grid grid-cols-1 md:grid-cols-4">
                                    <div class="p-2 font-semibold">วันเกิด</div>
                                    <div
                                        :class="[me.birthday ? 'p-2' : 'p-3', 'rounded-lg', 'border', 'bg-gray-50', 'col-span-3']">
                                        <a class="text-blue-800">{{ me.birthday }}</a>
                                    </div>
                                </div> -->
                                <div class="grid grid-cols-1 md:grid-cols-4">
                                    <div class="p-2 font-semibold">Email</div>
                                    <div
                                        :class="[me.email ? 'p-2' : 'p-3', 'rounded-lg', 'border', 'bg-gray-50', 'col-span-3']">
                                ...
                                <div class="grid grid-cols-1 md:grid-cols-4">
                                    <div class="p-2 font-semibold">เบอร์โทร</div>
                                    <div :class="{ 'p-3': !me.tel, 'p-2': me.tel }"
                                        class="rounded-lg border bg-gray-50 col-span-3">
                                        {{ me.tel }}
                                    </div>
                                </div>
                                <div></div>
                                <div class="grid grid-cols-1 md:grid-cols-4">
                                    <div class="p-2 font-semibold">ที่อยู่</div>
                                    <div class="p-2  rounded-lg col-span-3 border bg-gray-50">{{ me.address
                                        }} ตำบล {{ me.subdistrict }} อำเภอ {{
                        ...
                        <div class="flex justify-center w-full">
                            <button @click="showDialog"
                                class="block w-full bg-blue-500 p-2 mt-4 rounded-lg text-white hover:bg-blue-700">
                                แก้ไขข้อมูลส่วนตัว
                            </button>
                        </div>
                    </div>
                    ...
                    <div class="bg-white p-3 shadow-sm mt-3 rounded">
    ...
    <Dialog v-model:visible="editpassword" modal header="เปลี่ยนรหัสผ่าน"
        ...
        <div class="w-full bg-white">
            ...
            <div class="mb-3 sm:mb-6">
                ...
                <h1 class="text-xs mb-3 text-black">
            ...
            <div class="flex justify-end">
                <button @click="updatePassword" class="bg-blue-500 hover:bg-blue-700 text-white p-2 rounded">
                    อัปเดตรหัสผ่าน
                </button>
            </div>
