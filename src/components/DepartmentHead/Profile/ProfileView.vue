                        ...
                        <div class="md:flex-1 mt-2 mb:mt-0 md:px-3">
                            ...
                            <div class="md:flex mb-4">
                                <div class="md:flex-1 md:pr-3">
                                    <label
                                        class="block uppercase tracking-wide text-charcoal-darker text-xs font-bold">Username
                                    </label>
                                    <input v-model="editedMe.userid" class="w-full mt-2 ring-1 ring-inset focus:outline-none  shadow-[#1363DF] ring-[#85F4FF] focus:ring-2 focus:ring-inset
         focus:ring-[#47B5FF] shadow-sm   p-3 border-0" type="text">
                                </div>
                                <div class="md:flex-1 md:pr-3">
                                    <label
                                        class="block uppercase tracking-wide text-charcoal-darker text-xs font-bold">Password
                                    </label>
