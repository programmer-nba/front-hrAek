                        ...
                        <div class="text-black">
                            <div class="grid md:grid-cols-2 text-sm">
                                ...
                                <div class="grid grid-cols-2">
                                    ...
                                    <div class="px-4 py-2 bg-gray-200 border-gray-500 border-2 rounded-lg" v-else>หญิง
                                    </div>
                                </div>
                                ...
                                <div class="grid grid-cols-2">
                                    ...
                                    <div class="px-4 py-2 bg-gray-200 border-gray-500 border-2 rounded-lg">{{ me.tel }}
                                    </div>
                                </div>
                                <div></div>
                                <div class="grid grid-cols-2">
                                    <div class="px-4 py-2 font-semibold"> ที่อยู่</div>
                                    <div class="px-2 py-2 bg-gray-200 border-gray-500 border-2 rounded-lg">{{ me.address
